...
for d in range(0, 9): # Para cada dígito de 0 a 9
    nove_digitos += str(random.randint(0, 9)) # É realizada a concatenação de cada dígito gerado aleatoriamente (random)
